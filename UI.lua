-- Create a ScreenGui to hold the credits 
 ...
 local win = VLib:Window("阿巴阿巴", Color3.fromRGB(196, 40, 28)) 
  
 local ss1 = win:Tab("如何使用") 
 local ss = win:Tab("主要的") 
 local sss = win:Tab("杂项") 
 local cred = win:Tab("学分") 
  
 ss1:Button("你好，作者QQ168777105i",function() 
 game.CoreGui["Library"]:Destroy() 
 end) 
  
 ss:Button("Always",function() 
 loadstring(game:HttpGet("https://raw.githubusercontent.com/TakeModzz/Games-Hub-Script/main/Games%20Hub%20(Always%20updated)"))() 
 end) 
     
  ss:Button("监狱生活fe武器",function() 
 loadstring(game:HttpGet("https://pastebin.com/raw/AZVi2tuK"))() 
 end) 
  
 ss:Button("阿尔宙斯 ",function() 
 loadstring(game:HttpGet("https://raw.githubusercontent.com/AZYsGithub/chillz-workshop/main/Arceus%20X%20V3"))() 
 end) 
  
 ss:Button("Ghost Hub 100个脚本",function() 
 loadstring(game:HttpGet('https://raw.githubusercontent.com/GhostPlayer352/Test4/main/GhostHub'))() 
 end) 
  
 ss:Button("翻译器 gui ",function() 
 ...
 cred:Label("作者小云☁️") 
 cred:Label("验证 by arceus x | tw.piece zeltales和waza和Ismael") 
 cred:Label("请让我在下一次更新中放置你。") 
 cred:Label(" 谢谢你测试脚本。  ") 
 cred:Label(" V1.0.1   ")
