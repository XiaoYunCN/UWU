...
function lib:Window(text, preset, closebind)
    ...
    Main.Image = "rbxassetid://17648824640"
    ...
    ImageButton.Image = "rbxassetid://6031215982"
    ...
    ImageButton.MouseButton1Click:Connect(function()
        if uihide == false then
            ...
            uihide = false
            Main:TweenSize(UDim2.new(0, 560, 0, 319),"Out","Quad",0.4,true)
        end
    end)
    uihide = false
    ...
    TabHold.Size = UDim2.new(0, 600, 0, 254)
    ...
    TabHoldPadding.PaddingTop = UDim.new(0, 6)
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Slider(text, min, max, set, callback)
            ...
            sliderr.BackgroundTransparency = 0.7
            sliderr.Position = UDim2.new(0, 1, 0, 1)
            sliderr.Size = UDim2.new(0, 363, 0, 60)

            SliderCorner.CornerRadius = UDim.new(0, 5)
            SliderCorner.Name = "SliderCorner"
            SliderCorner.Parent = sliderr
            ...
            HAHA.Size = UDim2.new(0, 363, 0, 40)
            ...
            AHEHE.Size = UDim2.new(0, 343, 0, 5)
            ...
            bar.Size = UDim2.new(0, 343, 0, 5)

            bar1.Name = "bar1"
            bar1.Parent = bar
            bar1.BackgroundColor3 = PresetColor
            bar1.BackgroundTransparency = 0
            bar1.Size = UDim2.new(set/max, 0, 0, 5)

            circlebar.Name = "circlebar"
            circlebar.Parent = bar1
            circlebar.BackgroundColor3 = PresetColor
            ...
            slidervalue.Position = UDim2.new(0.8058126722, 0, 0.07, 0)
            ...
            AHEHE.MouseButton1Down:Connect(function()
                Value = math.floor((((tonumber(max) - tonumber(min)) / 343) * bar1.AbsoluteSize.X) + tonumber(min)) or 0
                pcall(function()
                    callback(Value)
                end)
                bar1.Size = UDim2.new(0, math.clamp(mouse.X - bar1.AbsolutePosition.X, 0, 343), 0, 5)
                circlebar.Position = UDim2.new(0, math.clamp(mouse.X - bar1.AbsolutePosition.X - 2, 0, 333), 0, -3)
                moveconnection = mouse.Move:Connect(function()
                    TextBox.Text = Value
                    Value = math.floor((((tonumber(max) - tonumber(min)) / 343) * bar1.AbsoluteSize.X) + tonumber(min))
                    pcall(function()
                        callback(Value)
                    end)
                    bar1.Size = UDim2.new(0, math.clamp(mouse.X - bar1.AbsolutePosition.X, 0, 343), 0, 5)
