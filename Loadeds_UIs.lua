local Global = getgenv and getgenv() or _G 
 ...
 do -- UI 
         local Pendulum = Library:New("Pendulum Hub 汉化版Ⅱ制作小云☁️") 
         local SettingsTab = Pendulum:NewTab("设置") 
         local CreditsTab = Pendulum:NewTab("信用") 
         local OMGFESEX = Pendulum:NewTab("性 ") 
         local LOL = Pendulum:NewTab("跳过音频更新") 
         local ScriptsTab = Pendulum:NewTab("脚本") 
         local reanimtype = SettingsTab:NewLabel(' 复活类型:' .. Global.Reanimation) 
         local flingtype = SettingsTab:NewLabel('投掷类型: ' .. Global.FlingType) 
         SettingsTab:NewLabel('注意:类人型部分投掷只在永久死亡开启后有效') 
         local anim = Pendulum:NewTab('动画ID播放器') 
         local cwScriptsTab = Pendulum:NewTab('咖啡具') 
          
 ...
                 SettingsTab:NewButton("切换永久死亡", "PermaDeath / Simple", function() 
 ...
                         end 
                 end, true) 
                 SettingsTab:NewButton("肘杆投掷式", "Prediction only / Click only / Mixed", function() 
 ...
                 ScriptsTab:NewButton("海神尼普顿的 V", "一个原件。如果你想要这顶帽子，请加入 discord.", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/34oqvdH"))() 
                 end) 
  
                 ScriptsTab:NewButton("音速的", "其他版本都不甩，除了这个。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3Cmw7BP"))() 
                 end) 
  
                 ScriptsTab:NewButton("Joy", "它有一些可爱的东西", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3IUQBUy"))() 
                 end) 
  
                 ScriptsTab:NewButton("Elio Blasio", "任何有枪的人。如果你想要帽子，加入 discord.", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3HYO4ru"))() 
                 end) 
  
                 ScriptsTab:NewButton("恩德", "Smashy boi", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/35VT02P"))() 
                 end) 
  
                 ScriptsTab:NewButton("KillBot V2", "剧本有点烂哈哈", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3sQWSuV"))() 
                 end) 
                  
                 ScriptsTab:NewButton("天上的星白金", "对于以前玩过jojo游戏的人来说，这是一个非常有趣的脚本。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3Cpvrvr"))() 
                 end) 
  
                 ScriptsTab:NewButton("寒冷", "你可以用这个吸引很多人的注意。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3pOdNfP"))() 
                 end) 
  
                 ScriptsTab:NewButton("卢特里斯 v2", "绝对是OP脚本。加入仇恨的纷争", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3vKDz8A"))() 
                 end) 
  
                 ScriptsTab:NewButton("梅穆斯 v2.5", "2019年死去的迷因(有些还没死)", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3tHxG9k"))() 
                 end) 
  
                 ScriptsTab:NewButton("Meme animation", "这只是一些表情和舞蹈。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/35YGnnw"))() 
                 end) 
  
                 ScriptsTab:NewButton("Krystal跳舞", "一些不错的舞蹈。我最喜欢的是你。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3KuRnbv"))() 
                 end) 
  
                 ScriptsTab:NewButton("旋转刀", "绝对有最好的空闲动画", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3HTllEm"))() 
                 end) 
  
                 ScriptsTab:NewButton("Xester", "所有剧本中最强的。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/35xGEyg"))() 
                 end) 
  
                 ScriptsTab:NewButton("卡杜库斯", "急躁的恶魔。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3Cln304"))() 
                 end) 
  
                 ScriptsTab:NewButton("迷你枪", "祝你喷洒滑板愉快。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3Cqns13"))() 
                 end) 
  
                 ScriptsTab:NewButton("闪电剑", "类似双Ultima。这基本上是一种编辑。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3CnTo6h"))() 
                 end) 
  
                 ScriptsTab:NewButton("腐败的监工", "我最喜欢的剧本。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3q8ECf5"))() 
                 end) 
  
                 ScriptsTab:NewButton("Darth Vadar", "对于星战迷来说。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3vPlhD8"))() 
                 end) 
  
                 ScriptsTab:NewButton("无", "左键投掷。用攻击的时间来投掷。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3vMd56u"))() 
                 end) 
  
                 ScriptsTab:NewButton("Zen", "字面意思是zenyata", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3IMQOcx"))() 
                 end) 
  
                 ScriptsTab:NewButton("大风战斗机", "又一经典！", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3ClMnTL"))() 
                 end) 
  
                 ScriptsTab:NewButton("手套和剑", "剧本没破按f装备。", function() 
                         loadstring(game:HttpGetAsync("https://bit.ly/3ISOvVv"))() 
                 end) 
  
                 ScriptsTab:NewButton("收割机", "Reaper from Overwatch", function() 
