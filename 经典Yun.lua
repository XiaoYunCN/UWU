...
function DarkraiX:Window(text,gamenme,logo,keybind)
	...
	Name.Text = hubname
	Name.TextColor3 = Color3.fromRGB(5,6,7)
	...
	Hub.Text = "  | "..gamename
	Hub.TextColor3 = Color3.fromRGB(5,6,7)
	Hub.TextSize = 17.000
	...
	BindButton.TextColor3 = Color3.fromRGB(5,6,7)
	...
	function uitab:Tab(text)
	    ...
	    TabButton.BorderColor3 = Color3.fromRGB(5,6,7)
